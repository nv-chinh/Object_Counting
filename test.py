...
from utils import setup, init_seeds
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt_type", type=str, default="word", help="The prompt type for CLIP.")
    ...
    parser.add_argument("--data_path", type=str, required=True, help="The dataset to train on.")
    parser.add_argument("--output_path", type=str, default = "results", help="The dataset to train on.")
    parser.add_argument("--dataset", type=str, default = "cow", help="The dataset to train on.")
