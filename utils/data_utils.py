...
def get_dataloader(args: ArgumentParser, split: str = "train", ddp: bool = False, mode: str = "train") -> Union[Tuple[DataLoader, Union[DistributedSampler, None]], DataLoader]:
    ...
    is_return_file = True if mode =='inference' else False
    if is_return_file:
        dataset = datasets.Crowd_Inference(
            data_path = args.data_path,
            dataset=args.dataset,
            split=split,
            transforms=transforms,
            sigma=None,
            return_filename=is_return_file,
